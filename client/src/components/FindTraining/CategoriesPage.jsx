	...
	return (
		<div className="container mx-auto p-6 bg-slate-50">
			...
			<div className="bg-gradient-to-r from-blue-500 to-purple-900 text-gray-200 p-10 rounded-lg mb-10">
				...
				<p className="text-lg">
					Find the perfect course to elevate your skills and advance your
					career.
				</p>
				<p className="text-lg">
					Contact us to learn more about our courses and how we can help you
					achieve your goals.
				</p>
				<button
			...
			<h1 className="text-3xl font-bold text-blue-600 mb-6 ml-4">
				Course Categories
			</h1>
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				{categories.map(category => (
					<div
						key={category.id}
						className="bg-white shadow-xl rounded-lg p-6 hover:shadow-2xl transition-shadow"
					>
						<div className="flex items-start mb-4">
							...
							<div>
								...
								<div className="grid grid-cols-1 gap-2">
									{sectors
										.filter(sector => sector.category_id === category._id)
										.map(sector => (
											<div
												key={sector.id}
