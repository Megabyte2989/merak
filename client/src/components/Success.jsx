      ...
      <section id="share-story-form" className="submit-story py-16 px-8 bg-russian-violet">
        <div className="container mx-auto">
          ...
          {!formSubmitted ? (
            ...
            >
              <div className="mb-4">
                <label htmlFor="name" className="block text-sm font-medium text-dogwood-rose mb-2">
                  Your Name
                </label>
                <input
                  type="text"
              ...
              <div className="mb-4">
                <label htmlFor="role" className="block text-sm font-medium text-dogwood-rose mb-2">
                  Your Role
                </label>
                <input
                  type="text"
              ...
              <div className="mb-4">
                <label htmlFor="story" className="block text-sm font-medium text-dogwood-rose mb-2">
                  Your Story
                </label>
                <textarea
                  id="story"
