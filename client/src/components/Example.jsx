...
function Example() {
  ...
  return (
    <>
      ...
      {/* DESKTOP */}
      <div className="hidden lg:flex space-x-10 justify-center text-[0.9rem]">
...
const FlyoutLink = ({ children, href, FlyoutContent }) => {
  ...
  return (
    ...
    >
      <a
        href={href}
        className={`relative duration-100 p-2 rounded-md  
				${!FlyoutContent ? "hover:bg-dogwood-rose" : ""}
				 ${!FlyoutContent ? "text-black hover:text-white" : ""} `}
        // style={{
        // 	color: 'black',
      ...
      >
        ...
        <span
          ...
          className=" absolute -bottom-2 -left-2 -right-2 lg:h-1 origin-left rounded-full bg-indigo-300 transitions-transform duration-300 ease-out"
        />
      </a>
      <AnimatePresence>
        {showFlyout && (
