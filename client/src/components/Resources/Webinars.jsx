...
const Webinars = () => {
	...
	const webinarData = [
		...
		},
		{
			...
			description:
				'Explore best practices for designing user-friendly interfaces.',
			link: '/register/3',
	...
	return (
		<section className="">
			{/* Section Header */}
			<div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 bg-raisin-black mt-10 mb-20 rounded-3xl">
				<h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-cool-gray md:text-5xl lg:text-6xl">
					Explore Upcoming Webinars
				</h1>
				<p
					className="mb-8 text-lg font-normal text-blue-400
				 md:text-xl lg:text-xl sm:px-16 xl:px-48"
				>
					From New Horizons
				</p>
			...
			<div className="grid gap-6 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 sm:grid-cols-2 px-6 lg:px-12">
